...
public class PhotoAdapterRtl extends RecyclerView.Adapter<PhotoAdapterRtl.PhotoViewHolder> {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        holder.mTextViewCover.setText(mDataSet[position].replace(".jpeg", ""));
...
//                mContext.startActivity(new Intent(mContext,FullPageAct.class));
                Intent i = new Intent(mContext, TransitionAct.class);

                View sharedView = holder.mImageViewCover;
                String transitionName = mContext.getString(R.string.blue_name);
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        protected ImageButton mButtonShare;
